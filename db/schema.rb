...
ActiveRecord::Schema.define(:version => 20150324154642) do
  ...
  add_index "assignments", ["activity_id", "guest_id"], :name => "index_activities_guests_on_activity_id_and_guest_id"
